...
#
get_filename_component(filename "/home/runner/work/webodf/webodf/build_test/downloads/compiler-20160911.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/webodf/webodf/build_test/ClosureCompiler-prefix/src/ClosureCompiler" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-ClosureCompiler${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-ClosureCompiler${i}")
