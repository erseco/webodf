...
#
get_filename_component(filename "/home/runner/work/webodf/webodf/build_test/downloads/rhino1_7R3.zip" ABSOLUTE)
get_filename_component(directory "/home/runner/work/webodf/webodf/build_test/Rhino-prefix/src/Rhino" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-Rhino${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-Rhino${i}")
