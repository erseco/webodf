...
#
get_filename_component(filename "/home/runner/work/webodf/webodf/build_test/downloads/jscoverage-0.5.1.tar.bz2" ABSOLUTE)
get_filename_component(directory "/home/runner/work/webodf/webodf/build_test/JSCoverage-prefix/src/JSCoverage" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-JSCoverage${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-JSCoverage${i}")
