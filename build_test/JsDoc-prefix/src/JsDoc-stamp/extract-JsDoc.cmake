...
#
get_filename_component(filename "/home/runner/work/webodf/webodf/build_test/downloads/jsdoc_toolkit-2.4.0.zip" ABSOLUTE)
get_filename_component(directory "/home/runner/work/webodf/webodf/build_test/JsDoc-prefix/src/JsDoc" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-JsDoc${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-JsDoc${i}")
