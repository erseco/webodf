...
#
get_filename_component(filename "/home/runner/work/webodf/webodf/build_test/downloads/dojo-release-1.10.4-src.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/webodf/webodf/build_test/Dojo-prefix/src/Dojo" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-Dojo${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-Dojo${i}")
